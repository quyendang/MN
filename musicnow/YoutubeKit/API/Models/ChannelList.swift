...
public struct ChannelMetadata: Codable {
    let title, description, keywords, defaultTab: String
    let showRelatedChannels, showBrowseView: Bool
    let featuredChannelsTitle: String
    let featuredChannelsUrls: [String]
    let unsubscribedTrailer, profileColor, country: String
}
