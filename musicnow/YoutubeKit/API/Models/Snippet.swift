...
extension Snippet {
    public struct SearchList: Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            liveBroadcastContent = try container.decode(String.self, forKey: .liveBroadcastContent)
            publishedAt = try container.decode(String.self, forKey: .publishedAt)
            thumbnails = try container.decode(Thumbnails.SearchList.self, forKey: .thumbnails)
            title = try container.decode(String.self, forKey: .title).htmlDecoded
        }
    }
}
...
extension Snippet {
    public struct PlaylistItemsList: Codable {
        public let channelID: String
        public let channelTitle: String
        public let snippetDescription: String
